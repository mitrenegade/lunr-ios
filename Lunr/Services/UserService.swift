    ...
    func generateProviders() {
        let plumbers =
            [User(
             ...
             User(
                ...
                rating: 5.0,
                reviews: [
                    Review(rating: 4.5, text: "Excellent! Phil responded quickly when I called about having him come for an estimate. Once we decided to have him do the work, he was terrific about communicating availability and scheduling and also to confirm the appointment the day before. He was on-time, did a great job and the work area was spotless afterward. I would definitely recommend Phil and we'll absolutely call him whenever we have plumbing needs in the future.  ")
                ],
                ratePerMin: 4.3,
                skills: ["Raiding", "Leadership"],
        ...
        let electricians =
            [User(
                ...
                rating: 5.0,
                reviews: [
                    Review(rating: 4.5, text: "I received a personal handwritten thank you note from the owner himself thanking me for choosing JDV Electric. Included in the note was a $25 coupon! I am very pleased with JDV Electric & recommend everyone to use his service! I will be a loyal customer going forward.")
                ],
                ratePerMin: 4.3,
                skills: ["Raiding", "Leadership"],
